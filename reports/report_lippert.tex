...
\begin{itemize}
  \item I'm studying in Paderborn
  \item From other project I know that this task is feasible\cite{parkendd}
  \item My intuition is that there are times in which the parking space is scarce, and on others there is much empty space
\end{itemize}
