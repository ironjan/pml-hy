...
The most important lesson I learned was: either set up something that checks in on the deployed system or check more regularly. Many of the problems were discovered too late because ``it worked on my local machine''.
